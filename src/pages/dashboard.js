                                ...
                                {!loading ?
                                    ...
                                    <div className="">
                                        ...
                                        <div className="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
                                            {data?.transactions && <ChartOne months={data?.transactions?.months} values={data?.transactions?.values} />}
                                            {data?.transactions && <ChartTwo days={data?.transactions?.days} values={data?.transactions?.day_values}/>} 
                                        </div>
